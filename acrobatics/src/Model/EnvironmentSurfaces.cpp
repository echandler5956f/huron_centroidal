...
namespace acro
{
    namespace environment
    {
        ...
        std::vector<int> EnvironmentSurfaces::getSurfacesUnder(const Eigen::Vector2d &ee_pos)
        {
        ...
        std::vector<SurfaceData> EnvironmentSurfaces::getSurfacesFromIndeces(const std::vector<int> indeces)
        {
