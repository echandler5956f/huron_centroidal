...
namespace acro
{
    namespace contact
    {
        ContactSequence::ContactSequence(int num_end_effectors)
        {
        ...
        int ContactSequence::getKnotAtTime(double t, CONTACT_SEQUENCE_ERROR &error_status)
        {
        ...
        void ContactSequence::getPhaseAtKnot(int knot_idx, Phase &phase, CONTACT_SEQUENCE_ERROR &error_status)
        {
        ...
        int ContactSequence::num_phases()
        {
